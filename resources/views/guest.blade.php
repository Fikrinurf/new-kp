...
@section('content')
    ...
    <section class="container hero-jadwal">

        <h1 class="text-center judul">Jadwal Booking</h1>

        <div class="mt-5">
            <form id="filter-form" class="container text-black">
                <div class="row">
            ...
            <div class="tab-content container mt-3 tabel-jadwal " id="orders-table-tab-content">
                    ...
                    <div class="app-card app-card-orders-table">
                        ...
                        <div class="app-card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-info  text-left rounded-3 " id="data-table">
                                    <thead>
                                        <tr>
                                            <th class="cell">No</th>
